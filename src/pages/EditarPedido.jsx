...
export default function EditarPedido() {
    ...
    return (
      <div className="p-6 max-w-2xl mx-auto text-center">
        <div className="bg-white rounded-lg shadow p-8">
          <h1 className="text-xl font-bold mb-2 font-display">Pedido não pode ser editado</h1>
          <p className="text-onforge-black/60 mb-6">
      ...
      <div className="p-6 max-w-2xl mx-auto text-center">
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <div className="flex gap-3 justify-center">
            <button onClick={() => navigate('/pedidos')} className="bg-onforge-black text-white px-4 py-2 rounded hover:bg-black/80">
              Ver Pedidos
            </button>
          </div>
        </div>
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <button onClick={() => navigate('/pedidos')} className="text-onforge-black hover:opacity-70 mb-4 flex items-center">
        ← Voltar para Pedidos
      </button>
      <h1 className="text-3xl font-bold mb-6 font-display">Editar Pedido nº {pedido?.numero}</h1>
